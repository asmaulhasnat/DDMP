...
//show  dist table
 ...
 if(isset($_POST['serch'])){
	 $serch=$_POST['serch'];
	 $selectQuery="SELECT district.*,division.divname FROM district, division where district.divid = division.divid and (divname like '".$serch."') limit $recordstart,$pagerecord";
	 }
	 else {
...
if (isset($_POST['serch'])){
	$ser=$_POST['serch'];
	$recordquary="select  count(*)from district,division where district.divid = division.divid and(divname like'".$ser."')";
	}else{
