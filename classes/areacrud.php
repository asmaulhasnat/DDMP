...
if(isset($_POST['uss'])){
	...
	$selectquary="select area.*,division.divid,district.distid from area,division,district where area.divid=division.divid and area.distid=district.distid and(area_name like '".$us."%') limit $recordstart,$pagerecord";	
	}
else{
$selectquary="select area.*,division.divid,district.distid from area,division,district where area.divid=division.divid and area.distid=district.distid  limit $recordstart,$pagerecord";
}
$result=$connection->query($selectquary);
...
if(isset($_POST['uss'])){
	$se= $_POST['uss'];
 $selectall="select count(*) from area where area_name like '".$se."%'";}
