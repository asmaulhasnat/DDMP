...
if(isset($_POST['uss'])){
	...
	$selectquary="select area.*,division.divid,district.distname,district.distid from area,division,district where area.divid=division.divid and area.distid=district.distid and(distname like '".$us."%') limit $recordstart,$pagerecord";	
	}
else{
$selectquary="select area.*,division.divid,district.distname,district.distid from area,division,district where area.divid=division.divid and area.distid=district.distid  limit $recordstart,$pagerecord";
}
$result=$connection->query($selectquary);
...
if(isset($_POST['uss'])){
	$se= $_POST['uss'];
 $selectall="select count(*)from area,division,district where area.divid=division.divid and area.distid=district.distid and(distname like '".$us."%')";}
